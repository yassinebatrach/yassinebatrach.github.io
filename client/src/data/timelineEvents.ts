...
export const timelineEvents = [
  {
    ...
    translations: {
      en: {
        ...
        description:
          "During a scheduled test, a power surge caused explosions in Reactor number 4, releasing radioactive material.",
      },
      it: {
        title: "25-26 Aprile 1986: Il Disastro",
        description:
          "Durante un test programmato, un picco di potenza provocò esplosioni nel reattore numero 4, liberando materiale radioattivo.",
      },
    },
    date: "1:23 AM, 26 Apr 1986",
  },
  {
    id: "evac",
    translations: {
